...
## Client
- Name: Alice Resident
- Email: alice@example.com    Phone: 0400000001
- Property: 45 Oxford Street Epping NSW 2121
- Enquiry purpose: develop

## Proposed service
Professional Review (planning) + possible survey/feasibility referral

## Scope (draft — confirm with client)
- Confirm planning controls / data relevant to "develop" for this property.
- Prepare a plain-English summary of confirmed facts and what still needs checking.
- Identify the right professional(s) and coordinate next steps.
