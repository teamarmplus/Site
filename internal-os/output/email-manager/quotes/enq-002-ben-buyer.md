...
- **Quote ID:** Q-ENQ-002-BEN-BUYE
- **Client:** Ben Buyer  (ben@example.com · 0400000002)
- **Property:** 12 Valentine Avenue Parramatta NSW 2150
- **Enquiry purpose:** buy

## Proposed service
Pre-purchase Professional Review

## Scope
- Confirm the NSW planning data relevant to "buy" for this property.
