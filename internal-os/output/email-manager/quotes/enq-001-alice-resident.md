# QUOTE / SERVICE DRAFT — NEEDS HUMAN APPROVAL
**Status:** DRAFT — not sent. No invoice. No payment link. T confirms price, scope, and sends manually.

- **Quote ID:** Q-ENQ-001-ALICE-RE
- **Client:** Alice Resident  (alice@example.com · 0400000001)
- **Property:** 45 Oxford Street Epping NSW 2121
- **Enquiry purpose:** develop

## Proposed service
Preliminary Professional Review (planning)

## Scope
- Confirm the NSW planning data relevant to "develop" for this property.
- Interpret what it means in plain English and flag what still needs professional verification.
- Identify and (if wanted) coordinate the right professional(s).

## Deliverables
- Plain-English summary of confirmed NSW planning facts
- Clear list of what still needs checking
- Recommended next step and suitable professional(s)
