...
## B. Client goal
**Purpose:** notsure
**Client:** Cara NoMatch | cara@example.com | 0400000004
**Address:** GEORGE STREET
**Enquiry notes:** No street number provided
...
> Hi Cara NoMatch, thanks for your Professional Review request for GEORGE STREET.
...
> Based on your goal (notsure), a useful next step is: Professional Review — ask the client for a complete NSW address, then re-run.
